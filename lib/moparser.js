...
class Parser {
  ...
  _loadTranslationTable () {
    ...
    for (let i = 0; i < this._total; i++) {
      ...
      msgid = convert(msgid, 'utf-8', this._charset)
        .toString('utf8');
      msgstr = convert(msgstr, 'utf-8', this._charset)
        .toString('utf8');
  ...
  _handleCharset (headers) {
    ...
    headers = convert(headers, 'utf-8', this._charset)
      .toString('utf8');
 ...
 */
module.exports = (buffer, defaultCharset) => {
