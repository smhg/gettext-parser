...
Where
  ...
  * **options** is a configuration object with possible values
    * **folding** (boolean|Function) - (default `false`) if `true`, Set to 0 or false to disable folding.
    * **foldLength** is the length at which to fold message strings into newlines (default: 76).
